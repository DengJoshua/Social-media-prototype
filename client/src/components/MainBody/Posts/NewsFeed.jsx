        ...
        <div style={{ padding: "10px" }}>
          ...
          <div className="section">
            <form>
              ...
              />
              <button
                className="btn btn-primary h-50 mt-2"
            ...
            <footer className="make-post">
              <section>
                <label>
                  ...
                  <i
                    className="fa fa-photo uploadButton text-primary"
                    componentclass="i"
                  />
                </label>
                <label>
                  ...
                  <i
                    className="fa fa-video-camera uploadButton text-secondary"
                    componentclass="i"
                  />
                </label>{" "}
                Video/ Photo
