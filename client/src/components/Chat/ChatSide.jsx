        ...
        return (
            <div className="chat-side" >
                ...
                <div className="friends" >
                    {friends.length === 0 ? <NavLink to="/me/home" className="text-center" >Find Friends</NavLink> :
                        friends.map(friend => friend.status === "pending" ? null : (
                            <NavLink className="friend d-flex"
